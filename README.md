...
- `/launch`는 `/public/shopping-cart-intake-kit`을 총소유비용 다음에 렌더링해 쇼핑몰 장바구니 텍스트를 총액, 필수 슬롯 누락, 옵션/사양 검수 prefill, 구매 승인 prefill로 변환한다.
